      ...
      SELECT
       ...
       SELECT
           "LinkedIn" as platform,
            ...
            linkedin_ads_ad_impressions.account_id AS account_id,
            linkedin_ads_ad_impressions.account_name AS account_name,
            linkedin_ads_ad_impressions.campaign_id AS campaign_id,
            linkedin_ads_ad_impressions.campaign_name AS campaign_name,
            linkedin_ads_ad_impressions.ad_group_id AS ad_group_id,
            linkedin_ads_ad_impressions.ad_group_name AS ad_group_name,
            linkedin_ads_ad_impressions.Impressions AS impressions,
            linkedin_ads_ad_impressions.Cost AS cost,
       ...
       SELECT
          ...
          cross_channel_impressions._date AS _date,
